// بيانات الأذكار - أذكار الصباح والمساء والتسابيح
...
export const morningAdhkar: Dhikr[] = [
  ...
  },
  {
    ...
    virtue: "من قالها ثلاثاً حين يصبح ويمسي كفته من كل شيء",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    virtue: "كانت له عدل عشر رقاب وكتب له مائة حسنة ومحيت عنه مائة سيئة",
  },
  {
    id: 19,
...
export const eveningAdhkar: Dhikr[] = [
  ...
  },
  {
    ...
    count: 100,
    reference: "رواه مسلم",
    virtue: "من قالها مائة مرة لم يأت أحد يوم القيامة بأفضل مما جاء به",
  },
  {
    id: 18,
...
export const tasbeehat: TasbihItem[] = [
  {
    id: "subhan_allah",
    text: "سُبْحَانَ اللَّهِ",
    translation: "تنزيهاً لله عن كل نقص",
    virtue: "كلمة يحبها الرحمن وتملأ الميزان",
    target: 33,
  },
  {
    id: "alhamdulillah",
    text: "الْحَمْدُ لِلَّهِ",
    translation: "الثناء لله على نعمه",
    virtue: "تملأ الميزان، ومن قالها حين يصبح وجبت له الجنة",
    target: 33,
  },
  {
    id: "allahu_akbar",
  ...
  },
  {
    ...
    translation: "لا معبود بحق إلا الله",
    virtue: "أفضل الذكر، ومن كان آخر كلامه دخل الجنة",
    target: 100,
  },
  {
    id: "subhan_allah_wa_bihamdih",
    text: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ",
    translation: "تنزيهاً لله مع حمده",
    virtue: "حُطَّت خطاياه وإن كانت مثل زبد البحر",
    target: 100,
  },
  {
    id: "subhan_allah_al_azim",
    text: "سُبْحَانَ اللَّهِ الْعَظِيمِ",
    translation: "تنزيهاً لله العظيم",
    virtue: "كلمتان حبيبتان إلى الرحمن خفيفتان على اللسان",
    target: 100,
  },
  {
    id: "la_hawla",
    text: "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ",
    translation: "لا تحول ولا قوة إلا بالله",
  ...
  },
  {
    ...
    translation: "أطلب المغفرة من الله",
  ...
  },
  {
    ...
    translation: "الصلاة والسلام على النبي",
  ...
  },
  {
    id: "la_ilaha_wahdah",
    text: "لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ",
    translation: "كلمة التوحيد مع تنزيه الله",
    virtue: "عدل عشر رقاب، وكتب له مائة حسنة، ومحيت عنه مائة سيئة",
    target: 10,
  },
  // ===== تسابيح طريقك للجنة =====
  {
    ...
    translation: "طلب الجنة والاستعاذة من النار",
    virtue: "من سأل الله الجنة ثلاث مرات قالت الجنة: اللهم أدخله الجنة",
    target: 3,
  },
  {
    id: "radhitu_billah",
    text: "رَضِيتُ بِاللَّهِ رَبًّا، وَبِالْإِسْلَامِ دِينًا، وَبِمُحَمَّدٍ ﷺ نَبِيًّا",
    translation: "الرضا بالله ربًا وبالإسلام دينًا وبمحمد نبيًا",
    virtue: "من قالها ثلاث مرات كان حقًا على الله أن يرضيه يوم القيامة",
    target: 3,
  },
  {
    id: "sayyid_istighfar",
    ...
    virtue: "من قالها موقنًا بها فمات دخل الجنة",
    target: 1,
  },
  {
    id: "subhan_allah_bihamdih_tree",
    text: "سُبْحَانَ اللَّهِ الْعَظِيمِ وَبِحَمْدِهِ",
    translation: "تنزيه الله العظيم مع حمده",
  ...
  },
  {
    ...
    translation: "الاستعاذة من النار",
    virtue: "من قالها سبع مرات حين يصبح وحين يمسي أجاره الله من النار",
    target: 7,
  },
  {
    id: "ashhadu_lailaha",
    text: "أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، وَأَشْهَدُ أَنَّ مُحَمَّدًا عَبْدُهُ وَرَسُولُهُ",
    translation: "شهادة التوحيد",
    virtue: "من كان آخر كلامه دخل الجنة",
    target: 10,
  },
];

export const hourlyAdhkar: Dhikr[] = [
  { id: 1, text: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ، سُبْحَانَ اللَّهِ الْعَظِيمِ", count: 1 },
  { id: 2, text: "لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ", count: 1 },
  { id: 3, text: "سُبْحَانَ اللَّهِ، وَالْحَمْدُ لِلَّهِ، وَلَا إِلَهَ إِلَّا اللَّهُ، وَاللَّهُ أَكْبَرُ", count: 1 },
  { id: 4, text: "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ الْعَلِيِّ الْعَظِيمِ", count: 1 },
  { id: 5, text: "أَسْتَغْفِرُ اللَّهَ الْعَظِيمَ الَّذِي لَا إِلَهَ إِلَّا هُوَ الْحَيَّ الْقَيُّومَ وَأَتُوبُ إِلَيْهِ", count: 1 },
  { id: 6, text: "اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ", count: 1 },
  { id: 7, text: "اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ وَشُكْرِكَ وَحُسْنِ عِبَادَتِكَ", count: 1 },
  { id: 8, text: "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ", count: 1 },
  { id: 9, text: "حَسْبِيَ اللَّهُ لَا إِلَهَ إِلَّا هُوَ عَلَيْهِ تَوَكَّلْتُ وَهُوَ رَبُّ الْعَرْشِ الْعَظِيمِ", count: 1 },
  { id: 10, text: "يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ، أَصْلِحْ لِي شَأْنِي كُلَّهُ", count: 1 },
];
