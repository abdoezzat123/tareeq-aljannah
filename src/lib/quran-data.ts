...
export const surahs: Surah[] = [
  ...
  { number: 60, name: "الممتحنة", englishName: "Al-Mumtahana", englishNameTranslation: "The Woman to be examined", numberOfAyahs: 13, revelationType: "Medinan" },
  ...
  { number: 78, name: "النبأ", englishName: "An-Naba", englishNameTranslation: "The Announcement", numberOfAyahs: 40, revelationType: "Meccan" },
  ...
  { number: 85, name: "البروج", englishName: "Al-Burooj", englishNameTranslation: "The Constellations", numberOfAyahs: 22, revelationType: "Meccan" },
  ...
  { number: 107, name: "الماعون", englishName: "Al-Maa'un", englishNameTranslation: "Almsgiving", numberOfAyahs: 7, revelationType: "Meccan" },
...
export const qaris = [
  { id: "ar.alafasy", name: "مشاري راشد العفاسي", identifier: "ar.alafasy" },
  { id: "ar.husary", name: "محمود خليل الحصري", identifier: "ar.husary" },
];

// تفسير السعدي - ملخص مختصر لكل سورة (سنستخدم API لتفاصيل الآيات)
export const tafsirSources = [
  { id: "saadi", name: "تفسير السعدي", description: "تيسير الكريم الرحمن في تفسير كلام المنان" },
  { id: "muyassar", name: "التفسير الميسر", description: "تفسير مبسط من مجمع الملك فهد" },
  { id: "ibnkathir", name: "تفسير ابن كثير", description: "تفسير القرآن العظيم بالأثر" },
];
